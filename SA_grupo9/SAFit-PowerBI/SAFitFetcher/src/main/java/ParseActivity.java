...
public class ParseActivity {
    ...
    public static void requestActivity(String ACCESS_TOKEN, DateTime yesterday, DateTime currentTime, FileWriter activityFile) throws IOException {
